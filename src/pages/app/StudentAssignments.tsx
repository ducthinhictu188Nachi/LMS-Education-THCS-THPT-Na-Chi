                ...
                <div className="space-y-4 mt-6 border-t border-slate-200 pt-6">
                  ...
                  <div className="space-y-4">
                    {selectedAssignment.questions.map((q, idx) => (
                      <div key={q.id} className="p-5 bg-white border border-slate-200 rounded-2xl shadow-sm">
                        ...
                        {q.type === 'true_false' && q.subQuestions && (
                          <div className="space-y-3 pl-2">
                            {q.subQuestions.map((subQ: any, subIdx: number) => (
                              <div key={subQ.id || subIdx} className="flex items-start justify-between gap-4 p-3 rounded-xl border border-slate-100 bg-slate-50">
