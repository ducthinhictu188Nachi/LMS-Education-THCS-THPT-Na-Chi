          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3 max-h-64 overflow-y-auto pr-2">
              {formData.questions?.map((q, index) => (
                <div key={q.id || index} className="p-3 border border-gray-200 rounded-xl bg-gray-50 relative group">
          ...
          {questionForm.type === 'true_false' && (
            <div className="space-y-4">
              ...
              {questionForm.subQuestions?.map((sq, idx) => (
                <div key={sq.id} className="p-4 border border-gray-200 rounded-xl bg-gray-50 space-y-3">
        ...
        <div className="space-y-4">
          ...
          <div className="max-h-96 overflow-y-auto border border-gray-200 rounded-xl">
            {bankQuestions.filter(q => {
              ...
              <label key={q.id} className="flex items-start gap-3 p-3 border-b border-gray-100 hover:bg-gray-50 cursor-pointer">
                <input 
                  type="checkbox"
