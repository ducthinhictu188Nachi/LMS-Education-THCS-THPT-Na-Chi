...
import { Lesson, Subject, Topic, Assignment, Submission, User, InteractiveBlock, Class, InteractiveQuestion, InteractiveQuestionType, Progress } from '../../core/types';
...
const StudentProgressRow = ({ student, progress, onSaveFeedback }: { student: User, progress: Progress | undefined, onSaveFeedback: (id: string, feedback: string) => Promise<void>, key?: any }) => {
